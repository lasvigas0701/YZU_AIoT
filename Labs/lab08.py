...
actionState = []
currentState = 0 # relax -> move -> Raise -> move -> relax
Raise_Count = 0
transCount = 0
missCount = 0
labels = ["Relax", "Move", "Raise"]
# actionState = ["Relax", "Move", "Raise", "Move", "Relax"]
actionState = ["Relax", "Raise", "Relax"]
